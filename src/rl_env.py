...
class CreditLimitEnv:
    ...
    def train_bal_3_predictors(self):
        ...
        predictor_features = self.state_space + ['UR_789', 'PR_789', 'INT', 'L_P_789', 'BALANCE_MEAN_PAST_789']
    ...
    def step(self, action):
        ...
        predictor_features = self.state_space + ['UR_456', 'PR_456', 'INT', 'L_P_456', 'BALANCE_MEAN_PAST_456']
